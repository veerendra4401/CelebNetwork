...
exports.CelebrityModule = CelebrityModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([celebrity_entity_1.Celebrity]),
            config_1.ConfigModule,
        ],
        providers: [celebrity_service_1.CelebrityService],
        controllers: [celebrity_controller_1.CelebrityController],
        exports: [celebrity_service_1.CelebrityService],
    })
], CelebrityModule);
